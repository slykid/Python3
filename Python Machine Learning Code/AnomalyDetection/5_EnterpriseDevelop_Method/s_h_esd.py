...
#   - 원인: Pandas 내 Int64Index 가 deprecated 되어 발생한 문제
#   - 아래 코드 실행 및 결과 확인은 판다스 버전 1.4 이전 버전을 사용할 것!
...
results = detect_ts(co2, max_anoms=0.10, direction='both')  # AttributeError: module 'pandas' has no attribute 'Int64Index'
# 원인: Pandas 내 Int64Index 가 deprecated 되어 발생한 문제
# 해결방법: 현재는 판다스 1.4 이전 버전 사용 밖에 없음
